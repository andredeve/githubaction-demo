<div class="row">
    <div class="col">
        <a class="btn btn-primary btn-loading align-middle" href="{$app_url}usuario/cadastrar"><i class="fa fa-user-plus"></i> Novo</a>
        <a class="btn btn-success btn-loading align-middle" href="{$app_url}grupo"><i class="fa fa-users"></i> Grupos</a>
    </div>
</div>
<hr/>
<div class="row">
        ...
        {foreach $usuarios as $usuario}
            <tr class="visualizar-entidade" entidade="Usuario" entidade_id="{$usuario->getId()}" modal_size="">
                ...
                <td>
                    ...
                    <a class="btn btn-warning btn-xs btn-loading btn-editar-no-propagate" title="Cadastrar no Sistena de Assinatura Digital" href="{$app_url}assinatura/cadastrar/id/{$usuario->getId()}"><i class="fa fa-user-plus"></i></a>
                    {/if}
                    <a class="btn btn-info btn-xs btn-loading btn-editar-no-propagate" title="Editar" href="{$app_url}usuario/editar/id/{$usuario->getId()}"><i class="fa fa-edit"></i></a>
