<a class="btn btn-primary btn-loading" href="{$app_url}subTipoLocal/cadastrar"><i class="fa fa-plus"></i> Novo</a>
<hr/>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-info btn-xs btn-loading" title="Editar"
                   href="{$app_url}subTipoLocal/editar/id/{$local->getId()}"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger btn-xs btn-excluir" title="Excluir"
                   href="{$app_url}subTipoLocal/excluir/id/{$local->getId()}"><i class="fa fa-times"></i></a>
            </td>
        </tr>
    {/foreach}
    </tbody>
