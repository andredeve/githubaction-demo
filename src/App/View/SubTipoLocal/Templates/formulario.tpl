...
{/if}
<form id="localForm" class="form-horizontal form-validate" method="POST" action="{$app_url}subTipoLocal/{$acao}">
    ...
    <div class="form-group row">
        <div class="col">
            ...
            {if !isset($modal) ||  $modal eq false}
                <a href="{$app_url}subTipoLocal" class="btn btn-light border"><i class="fa fa-times"></i> Cancelar</a>
            {else}
