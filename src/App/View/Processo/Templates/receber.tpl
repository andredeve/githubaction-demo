...
<div class="processo-table">
    ...
    <form id="receberProcessosForm" method="POST" action="{$app_url}tramite/receber">
        <div class="pull-right">
            ...
            <button type="submit" title="Receber trâmite(s) selecionado(s)"
                    class="btn btn-info text-white ladda-button"><i class="fa fa-check"></i> Receber
            </button>
        </div>
        <table id="tabelaProcessosReceber"
               class="table table-bordered table-hover table-sm tabelaProcessos text-center"
               hide_checkbox=""
               tipo_listagem="receber"
               verificar_vencimento="true"
               url="{$app_url}src/App/Ajax/Processo/listar_server_side.php?tipo_listagem=receber">
