...
$smarty->assign("page_title", \Core\Controller\AppController::getParametosConfig('nomenclatura') . 's a Receber (' . \Core\Controller\AppController::getParametosConfig('contribuinte') . ')');
