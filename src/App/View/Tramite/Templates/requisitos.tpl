...
{if isset($assunto) and $assunto->getFluxograma() neq null}
                ...
                <div id="divRequisitos">
                    {if count($setor_fase->getCampos()) gt 0}
                                                    ...
                                                    {if $campo->getAssinaturaObrigatoria() and !$usuarioEhInteressado}
                                                        <div class="form-group m-2 row">
                                                            <div class="col-3">
                                                                ...
                                                                <input type="text" value="" name="data_assinatura_campo_{$campo->getId()}[{$countCampos}]"
                                                                    id="data_assinatura_campo_{$campo->getId()}[{$countCampos}]"
                                                                ...
                                                                <div class="col-3">
                                                                    <div style="display: flex;justify-content: space-between">
                                                                        ...
                                                                        <span class="col-form-label">
                                                                            Autonumerar?
                                                                            <input type="checkbox" class="ignore-validate"
                                                                                id="documento_auto_numeric_{$campo->getId()}[{$countCampos}]"
                                                                                name="documento_auto_numeric_{$campo->getId()}[{$countCampos}]" value="0"
                                                                                onchange="alternarEntradaNumeroAnexo(this,'numero_campo_{$campo->getId()}_{$countCampos}')" />
                                                                        </span>
                                                                    </div>
                                                                    <input type="number" name="numero_campo_{$campo->getId()}[{$countCampos}]"
                                                                        id="numero_campo_{$campo->getId()}_{$countCampos}" class="form-control form-control-sm"
                                                                        {if $campo->getIsObrigatorio() eq true}required="true" {/if}>
                                                                </div>
                                                                <div class="col-3">
                                                                    <label
                                                                        class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Ano:</label>
                                                                    <input type="text" name="ano_campo_{$campo->getId()}[{$countCampos}]"
                                                                        id="ano_campo_{$campo->getId()}[{$countCampos}]"
                                                                        class="form-control form-control-sm ano" maxlength="4" onchange="validaAno($(this));"
                                                                        {if $campo->getIsObrigatorio() eq true}required="true" {/if}>
                                                                </div>
                                                                <div class="col-3">
                                                                    <label class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Data
                                                                        Emissão:</label>
                                                                    <input type="text" value="" name="data_campo_{$campo->getId()}[{$countCampos}]"
                                                                        id="data_campo_{$campo->getId()}[{$countCampos}]"
                                                                        class="form-control form-control-sm datepicker"
                                                                        {if $campo->getIsObrigatorio() eq true}required="true" {/if}>
                                                                </div>
                                                            {/if}
                                                    ...
                                                    <div class="form-group row">
                                                        {if $campo->getAssinaturaObrigatoria() eq true}
                                                            <div class="col-6">
                                                                ...
                                                                <select name="grupo_assinatura_campo_{$campo->getId()}[{$countCampos}][]"
                                                                    id="grupo_assinatura_campo_{$campo->getId()}[{$countCampos}]"
                                                                    ...
                                                                    {if isset($grupos) and !empty($grupos)}
                                                                        {foreach $grupos as $grupo}
                                                                            <option value="{$grupo->id}" data-toggle="tooltip" {if !empty($grupo->signatarios)}
                                                                                    title="{foreach $grupo->signatarios as $signatario} - {$signatario->nome} ({$signatario->cargo})&#010; {/foreach}"
                                                                                    data-signatarios="{$grupo->signatarios}" {/if} {if !empty($grupo->empresa)}
                                                                                data-empresa="{$grupo->empresa->id}" {/if}>{$grupo->nome}</option>
                                                                        {/foreach}
                                                                    {/if}
                                                                </select>
                                                            </div>
                                                            <div class="col-6">
                                                                <label
                                                                    class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Signatários:</label>
                                                                <select name="signatario_assinatura_campo_{$campo->getId()}[{$countCampos}][]"
                                                                    id="signatario_assinatura_campo_{$campo->getId()}[{$countCampos}]"
                                                                    class="select2 form-control signatario_assinatura {if $campo->getAssinaturaObrigatoria() eq false}ignore-validate{/if}"
                                                                    multiple {if $campo->getIsObrigatorio() eq true}required{/if}>
                                                                    <option value="">Selecione</option>
                                                                    {if !empty($signatarios)}
                                                                        {foreach $signatarios as $signatario}
                                                                            <option value="{$signatario->id}" data-toggle="tooltip" title="{$signatario->nome}">
                                                                                {$signatario->nome}
                                                                            </option>
                                                                        {/foreach}
                                                                    {/if}
                                                            ...
                                                            <div class="col-6">
                                                                <label
                                                                    class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Empresa:</label>
                                                                <select id="empresa_campo_{$campo->getId()}[{$countCampos}]"
                                                                    ...
                                                                    name="empresa_campo_{$campo->getId()}[{$countCampos}]"
                                                                    {if $campo->getIsObrigatorio() eq true}required{/if}>
                                                                    <option value="">Selecione</option>
                                                                    {foreach $empresas as $item}
                                                                        <option value="{$item->id}" data-toggle="tooltip"
                                                                            {if $assinatura && $assinatura->getEmpresa() === $item->id} selected="selected"
                                                                            {/if}>
                                                                            {$item->nome}
                                                                        </option>
                                                                    {/foreach}
                                                            ...
                                                            <div class="col-6">
                                                                <label class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Tipo
                                                                    de Documento:</label>
                                                                <select id="tipo_documento_campo_{$campo->getId()}[{$countCampos}]"
                                                                    ...
                                                                    name="tipo_documento_campo_{$campo->getId()}[{$countCampos}]"
                                                                    {if $campo->getIsObrigatorio() eq true}required={/if}>
                                                                    <option value="">Selecione</option>
                                                        ...
                                                        <div id="div-{$countDiv}-insere-arquivo-{$countCampos}" class="col-12">
                                                            ...
                                                            <input type="file" accept="application/pdf"
                                                                name="campo_{$campo->getId()}[{$countCampos}][]"
                                                                id="campo_{$campo->getId()}[{$countCampos}]" class="fileinput"
                                                                {if $campo->getIsObrigatorio() eq true} required="true" {/if} multiple>
                                                            <div id="campo_{$campo->getId()}[{$countCampos}]-error"></div>
                                                        </div>
                                                        <hr />
                                                    </div>
                                                </div>
                                                {if $campo->getAssinaturaObrigatoria() eq true}
                                                    <div id='mais-arquivos-{$countDiv}' qtde="0" data-campo-id="{$campo->getId()}">
                                                    </div>
                                                    <div class="text-center p-2">
                                                        <button type="button" class="btn btn-circle btn-sm btn-success btn-adicionar-campo"
                                                            add-id="{$countDiv}" href="javascript:">
                                                            <i class="fa fa-plus fa-lg"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-circle btn-sm btn-danger btn-remover-campo"
                                                            remove-id="{$countDiv++}" href="javascript:">
                                        ...
                                        <fieldset>
                                            ...
                                            {if $campo->getAssinaturaObrigatoria() and !$usuarioEhInteressado}
                                                <div class="form-group row">
                                                    <div class="col-3">
                                                        <label class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Data
                                                            Limite Assinatura:</label>
                                                        <input type="text" value="" name="data_assinatura_campo_{$campo->getId()}"
                                                            class="form-control form-control-sm datepicker"
                                                            {if $campo->getIsObrigatorio() eq true}required="true" {/if}>
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Ano:</label>
                                                        <input type="text" name="ano_campo_{$campo->getId()}" class="form-control form-control-sm ano"
                                                            maxlength="4" onchange="validaAno($(this));"
                                                            {if $campo->getIsObrigatorio() eq true}required="true" {/if}>
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="col-form-label {if $campo->getIsObrigatorio() eq true}required{/if}">Data
                                                            Emissão:</label>
                                                        <input type="text" value="" name="data_campo_{$campo->getId()}"
                                                            class="form-control form-control-sm datepicker"
                                                            {if $campo->getIsObrigatorio() eq true}required="true" {/if}>
                                                    </div>
                                                    <div class="col-6">
                                                        ...
                                                        <select name="grupo_assinatura_campo_{$campo->getId()}[]"
                                                            class="ignore-validate select2 form-control grupo_assinatura" data-campo-id="{$campo->getId()}"
                                                            multiple>
                                                            <option value="">Selecione</option>
                                                            {if isset($grupos) and !empty($grupos)}
                                                                {foreach $grupos as $grupo}
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <select id="empresa_campo_{$campo->getId()}"
                                                            class="select2 form-control select_empresa select_empresa_{$campo->getId()} {if $campo->getAssinaturaObrigatoria() eq false}ignore-validate{/if}"
                                                            name="empresa_campo_{$campo->getId()}" {if $campo->getIsObrigatorio() eq true}required{/if}>
                                                            <option value="">Selecione</option>
                                                            {foreach $empresas as $item}
                                                                <option value="{$item->id}" data-toggle="tooltip"
                                                                    {if $assinatura && $assinatura->getEmpresa() === $item->id} selected="selected" {/if}>
                                                                    {$item->nome}
                                                                </option>
                                                            {/foreach}
                                                        </select>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <select id="tipo_documento_campo_{$campo->getId()}"
                                                            ...
                                                            {foreach $tipos_documentos as $item}
                                                                <option value="{$item->id}" data-toggle="tooltip"
                                                                    {if $assinatura && $assinatura->getTipoDocumento() === $item->id} selected="selected" {/if}>
                                                                    {$item->nome}
                                                                </option>
                                                            {/foreach}
                                                        </select>
                                            ...
                                            <div class="form-group m-2 row">
                                                <div class="col">
                                                    ...
                                                    {/if}
                                                    <input type="file" accept="application/pdf" id="campo_{$campo->getId()}"
                                                        name="campo_{$campo->getId()}[]" class="fileinput" multiple="true"
                                                        {if $campo->getIsObrigatorio() eq true}required="true" {/if}>
                                            ...
                                            {if $campo->getTipo() eq App\Enum\TipoCampo::TEXTO}
                                                <input type="text" name="campo_{$campo->getId()}"
                                                    class="form-control form-control-sm {$campo->getMascara()}" {if $campo->getIsObrigatorio() eq true}
                                                        {if $campo->getIsObrigatorio() eq true}required="true" {/if} {/if} />
                                                ...
                                                {elseif $campo->getTipo() eq App\Enum\TipoCampo::CAIXA_SELECAO}
                                                    <select data-placeholder="Selecione" name="campo_{$campo->getId()}"
                                                        class="form-control select2 form-control-sm" {if $campo->getIsObrigatorio() eq true}required="true"
                                                        {/if}>
                                                        <option value=""></option>
                                                ...
                                                {elseif $campo->getTipo() eq App\Enum\TipoCampo::NUMERO}
                                                    <div class="input-group">
                                                        ...
                                                        <input type="{if $campo->getMascara() eq App\Enum\MascaraCampo::MOEDA}text{else}number{/if}"
                                                            ...
                                                            name="campo_{$campo->getId()}" {if $campo->getIsObrigatorio() eq true}required="true" {/if} />
                                                    </div>
                                                {elseif $campo->getTipo() eq App\Enum\TipoCampo::DATA}
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm data datepicker" name="campo_{$campo->getId()}"
                                                            {if $campo->getIsObrigatorio() eq true}required="true" {/if} />
                                                    </div>
                                                {elseif $campo->getTipo() eq App\Enum\TipoCampo::HORA}
                                                    <div class="input-group">
                                                        ...
                                                        <input type="time" class="form-control form-control-sm hora" name="campo_{$campo->getId()}"
                                                            {if $campo->getIsObrigatorio() eq true}required="true" {/if} />
                                                    </div>
                                                {elseif $campo->getTipo() eq App\Enum\TipoCampo::EMAIL}
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control form-control-sm" name="campo_{$campo->getId()}"
                                                            {if $campo->getIsObrigatorio() eq true}required="true" {/if} />
                                                    </div>
                                                {/if}
                        ...
                        {if count($setor_fase->getPerguntas()) gt 0}
                            <div class="card">
                                <div class="card-header text-center p-1"><span><i class="fa fa-question-circle-o"></i> Questionário de
                                        perguntas</span>
                                </div>
                                    ...
                                    <tbody>
                                        {foreach $setor_fase->getPerguntas() as $pergunta}
                                            {if $pergunta->getIsAtiva() eq true}
                                                <tr>
                                                    <th class="text-center bg-light vertical-middle" style="width: 4%">{$pergunta@iteration}</th>
                                                    <td>
                                                        {$pergunta}
                                                        <br />
                                                    ...
                                                    <td class="text-center vertical-middle" style="width: 20%">
                                                        ...
                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            <label class="btn btn-outline-success btn-sm">
                                                                <input type="radio" name="resposta_{$pergunta->getId()}" value="1" autocomplete="off">
                                                                <i class="fa fa-check"></i> Sim
                                                            </label>
                                                            <label class="btn btn-outline-danger btn-sm">
                                                                <input type="radio" name="resposta_{$pergunta->getId()}" value="0" autocomplete="off">
                                                                <i class="fa fa-times"></i> Não
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td style="width: 30%">
                                                        <textarea name="observacoes_{$pergunta->getId()}" class="form-control"></textarea>
                                                    </td>
                                                </tr>
                                            {/if}
                                        {/foreach}
                        ...
                        {if count($setor_fase->getTarefas()) gt 0}
                            <div class="card">
                                <div class="card-header text-center p-1"><span><i class="fa fa-check-square-o"></i> Tarefas a serem
                                        realizadas<span style="color: red;"> *</span></span>
                                </div>
                                <div class="card-body">
                                    <ul class="list-group">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input check-tarefa"
                                                            id="customCheck{$tarefa->getId()}" name="tarefa_realizada[{$i}]" value="{$tarefa->getId()}"
                                                            required>
                                                        <label class="custom-control-label" title="{$tarefa->getOrientacao()}"
    ...
    <script id="requisitosjs" defer type="text/javascript"
        src="{$app_url}assets/js/view/tramite/requisitos.js?v={if isset($file_version) && !empty($file_version) }{$file_version}{/if}">
    </script>

<script defer type="text/javascript" src="{$app_url}assets/js/view/tramite/adicionar_campos.js?v={if isset($file_version) && !empty($file_version) }{$file_version}{/if}"></script>