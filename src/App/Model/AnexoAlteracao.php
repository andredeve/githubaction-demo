 ...
 * @Table(name="anexo_alteracao", indexes={@Index(name="exercicio_index", columns={"exercicio"}), @Index(columns={"descricao"}, flags={"fulltext"})})
 */
class AnexoAlteracao extends AppModel {
    ...
    function gerarNumero(){
        if($this->getIsAutoNumeric() && empty($this->getNumero()) && !empty($this->getProcesso()->getNumero())){
            ...
            $this->numero = $this->getProcesso()->getNumero() . date("y") . $novoNumero;
        }
    }
