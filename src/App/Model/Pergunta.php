...
/**
 * @Entity
 * @Table(name="pergunta",uniqueConstraints={@UniqueConstraint(name="pergunta_unique", columns={"descricao", "setor_fase_id"})})
 */
class Pergunta extends AppModel {
     ...
     * @JoinColumn(name="pergunta_pai_id", referencedColumnName="id",nullable=true)
     */
    private $perguntaPai;
    ...
    function setPerguntaPai($perguntaPai) {
