...
// ====================================================================================================================
	...
	public static function UTF8ArrayToUniArray($ta, $isunicode=true) {
		if ($isunicode) {
			return array_map(array(TCPDF_FONTS::class, 'unichrUnicode'), $ta);
		}
		return array_map(array(TCPDF_FONTS::class, 'unichrASCII'), $ta);
	}
	...
	public static function UTF8StringToArray($str, $isunicode=true, &$currentfont) {
		if ($isunicode) {
			...
			$carr = array_map(array(TCPDF_FONTS::class, 'uniord'), $chars);
		} else {
			$chars = str_split($str);
