...
class TCPDF {
	 ...
	 * @param $type (string) type of barcode (see TCPDFBarcode.php for supported formats).
	 ...
	 * Print 2D Barcode.
	 * @param $code (string) code to print
	 * @param $type (string) type of barcode (see TCPDF2DBarcode.php for supported formats).
